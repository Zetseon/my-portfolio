			...
			<div className={` justify-center items-center w-full h-full md:px-8 lg:px-20 `}>
				...
				<div
					...
					<div className="flex flex-col items-center sm:w-3/4 p-2">
						<h1 className="text-sm sm:text-md text-left mb-2 sm:mb-4 lg:mb-8">
						...
						<a
							...
							className="mt-4 px-4 py-3 bg-button text-white rounded-lg hover:bg-fourth hover:text-primary hover:cursor-pointer focus:outline-solid focus:ring focus:border-teal-300">
							Resume
						</a>
					</div>
				</div>
			...
			<div className="flex flex-col justify-center w-full h-full md:px-8 lg:px-20">
				...
				<div className="flex flex-col sm:flex-row gap-4">
					...
					<div
						...
						<h2 className="text-lg text-txt mb-2">Web Development:</h2>
						{/* Display Web Dev skills in a more structured way */}
						<div className="flex flex-wrap gap-2">
							{webDev.map((skill, index) => (
								<span
									key={index}
									className="px-2 py-1 bg-button text-txt rounded-md">
									{skill}
								</span>
							))}
						</div>
					...
					<div
						...
						<h2 className="text-lg text-txt mb-2">Languages:</h2>
